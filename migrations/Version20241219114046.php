...
final class Version20241219114046 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE single (id INT AUTO_INCREMENT NOT NULL, artist_id INT NOT NULL, name VARCHAR(255) NOT NULL, release_date DATE NOT NULL, duration INT NOT NULL, artwork VARCHAR(455) NOT NULL, spotify_link VARCHAR(455) DEFAULT NULL, youtube_linke VARCHAR(455) DEFAULT NULL, soundcloud_link VARCHAR(455) DEFAULT NULL, is_released_as_single TINYINT(1) NOT NULL, INDEX IDX_CAA72719B7970CF8 (artist_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
