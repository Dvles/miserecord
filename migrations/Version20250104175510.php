 ...
 */
final class Version20250104175510 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE genre (id INT AUTO_INCREMENT NOT NULL, album_id INT DEFAULT NULL, single_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, INDEX IDX_835033F81137ABCF (album_id), INDEX IDX_835033F8E7C1D92B (single_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE genre ADD CONSTRAINT FK_835033F81137ABCF FOREIGN KEY (album_id) REFERENCES album (id)');
        $this->addSql('ALTER TABLE genre ADD CONSTRAINT FK_835033F8E7C1D92B FOREIGN KEY (single_id) REFERENCES single (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE genre DROP FOREIGN KEY FK_835033F81137ABCF');
        $this->addSql('ALTER TABLE genre DROP FOREIGN KEY FK_835033F8E7C1D92B');
